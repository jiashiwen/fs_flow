...
#[cfg(test)]
mod test {
    use crate::commons::{byte_size_str_to_usize, byte_size_usize_to_str, normalize_path};
    ...
    //cargo test commons::convert::test::test_normalize_path -- --nocapture
    #[test]
    fn test_normalize_path() {
        let r = normalize_path("/a//b///c");
        println!("{:?}", r);
    }
}
