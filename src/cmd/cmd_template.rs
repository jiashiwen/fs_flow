...
fn template_compare() -> Command {
    clap::Command::new("compare")
        .subcommand(template_compare_oss2oss())
        .subcommand(template_compare_oss2local())
        .subcommand(template_compare_local2oss())
        .subcommand(template_compare_local2local())
}

fn template_compare_oss2oss() -> Command {
    clap::Command::new("oss2oss")
        .about("template for local to local compare task")
        .args(&[Arg::new("file")
            .value_name("file")
            .required(false)
            .index(1)
...
fn template_compare_oss2local() -> Command {
    clap::Command::new("oss2local")
        .about("template for oss to local compare task")
        .args(&[Arg::new("file")
            .value_name("file")
            .required(false)
            .index(1)
...
fn template_compare_local2oss() -> Command {
    clap::Command::new("local2oss")
        .about("template for local to oss compare task")
        .args(&[Arg::new("file")
            .value_name("file")
            .required(false)
            .index(1)
...
fn template_compare_local2local() -> Command {
    clap::Command::new("local2local")
        .about("template for local to local compare task")
        .args(&[Arg::new("file")
            .value_name("file")
